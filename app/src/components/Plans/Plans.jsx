...
const tiers = [
  {
    ...
    features: ['25 entries', 'Email support'],
    featured: false,
  },
  {
    name: 'Enterprise',
...
const Plans = () => {
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-light text-pretty text-gray-600 sm:text-xl/8">
